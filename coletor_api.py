...
def coletar_dados():
    ...
    iterando por cada letra do alfabeto.
    """
    alfabeto = string.ascii_lowercase  # Gera uma string com 'abcdefghijklmnopqrstuvwxyz'
    todas_as_receitas = []

    print("Iniciando a coleta de dados da TheMealDB...")
    ...
    for letra in alfabeto:
        ...
        # Política de Polidez: Espera 1 segundo entre as requisições para não sobrecarregar a API
        time.sleep(1)
    ...
    with open(nome_arquivo, 'w', encoding='utf-8') as f:
        ...
        # ensure_ascii=False para garantir que caracteres especiais (acentos, etc.) sejam salvos corretamente
